...
class EntradasCartLib {
    ...
    private function _insert($items = [], $update = false, $rowid_) {
        ...
        $price_neto = $items["price"] - $descuentos; //AQUI HAY QUE SUMAR EL ICE Y EL IBMR
        $qty = $items["qty"];
...
//        $iceval = 0;
    ...
    private function applyItemToTotals(&$meta, $item, $factor = 1) {
        ...
        // ICE
        $iceVal = $icePorcent > 0 ? ($priceneto * $icePorcent) / 100 : 0; //Esto lo vamos a usar para procesos como compras y ventas
//        $iceVal = 0;
