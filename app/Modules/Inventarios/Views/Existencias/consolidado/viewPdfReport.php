...
<table class="report">
    ...
    <tbody>
        ...
        foreach ($data as $item):
            ...
            $disponible = esc($item->stock - $item->reservaProducto);
            ...
            <tr>
                ...
                <td><?= esc($item->lot_lote?$item->lot_lote:"--") ?></td>
                <td><?= esc($item->lot_fecha_caducidad?$item->lot_fecha_caducidad:"--") ?></td>
                <td class="text-right"><?= esc($item->stock) ?></td>
