...
<!--
/**
 * Description of viewModalProducto
 *
/**
...
<div id="modalProductos" ref="modalProductos" class="modal fade" data-bs-backdrop="static" dat-bs-keyboard="false">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class=""><i class="fas fa-box-open"></i> Actualizar Producto</h5>
            ...
            <div class="modal-body">
                ...
                <div class="col-md-12 ">
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input  v-model="editProducto.prodNombre" type="text" class="form-control" id="prodNombre" placeholder="Ingrese un nombre" />
                            <!--validaciones-->
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input  v-model="editProducto.prodCodigo" type="text" class="form-control" id="prodCodigo" placeholder="Ingrese un código" />
                            <!--validaciones-->
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input  v-model="editProducto.prodCodigoBarras" type="text" class="form-control" id="prodCodigoBarras" placeholder="Ingrese un codigo de barras" />     
                        </div>       
                        <div class="mb-3 col-md-6">
                            <label for="prodCodigoBarras2" class="col-form-label col-form-label-sm"><i class="fal fa-file-check"></i> Cod Barras 2</label>
                            <input  v-model="editProducto.prodCodigoBarras2" type="text" class="form-control" id="prodCodigoBarras2" placeholder="Ingrese un codigo de barras" />                               
                        </div>       
                    </div>  
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            <label for="prodCodigoBarras3" class="col-form-label col-form-label-sm"><i class="fal fa-file-check"></i> Cod Barras 3</label>
                            <input  v-model="editProducto.prodCodigoBarras3" type="text" class="form-control" id="prodCodigoBarras3" placeholder="Ingrese un codigo de barras" />   
                        </div>  
                        <div class="mb-3 col-md-6">                             
                            <label for="prodMarca" class="col-form-label col-form-label-sm"><i class="fal fa-file-check"></i> Marca</label>
                            <select v-model="editProducto.prodMarca" class="form-select border" id="prodMarca">
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">
                            ...
                            <input  v-model="editProducto.prodExistenciaMinima" type="number" class="form-control" id="prodExistenciaMinima" placeholder="Ingrese el Stock minimo" />   
                        </div>       
                        <div class="mb-3 col-md-6">
                            <label for="prodExistenciaMaxima" class="col-form-label col-form-label-sm"><i class="fal fa-file-check"></i> Stock Max</label>
                            <input  v-model="editProducto.prodExistenciaMaxima" type="number" class="form-control" id="prodExistenciaMaxima" placeholder="Ingrese el Stock minimo" />   
                        </div>       
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-6">                             
                            ...
                            <select v-model="editProducto.prodUnidadMedida" class="form-select border" id="prodUnidadMedida">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input  v-model="editProducto.prodValorMedida" type="number" class="form-control" id="prodValorMedida" placeholder="0.00" />   
                        </div>   
                    </div>
                    <div class="row">
                        <div class="mb-3 col-md-6">                                      
                            ...
                            <select v-model="editProducto.grupo" @change="getSubgrupo" class="form-select border" id="prodGrupo">
                        ...
                        <div class="mb-3 col-md-6">    
                            ...
                            <select v-model="editProducto.prodSubgrupo"  class="form-select border" id="prodSubgrupo">
                                <option v-for="lsg of listaSubGruposModalFilter" v-bind:value="lsg.id">{{lsg.sgr_nombre}}</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-6">                             
                            ...
                            <select v-model="editProducto.prodTipoProducto"  class="form-select border" id="prodTipoProducto">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="mb-3 col-md-6">                             
                            ...
                            <select  v-model="editProducto.prodTieneICE"  class="form-select border" @change="aplicaIce()" id="prodTieneICE">
                        ...
                        <div class="mb-3 col-md-6">                             
                            ...
                            <select id="selectImpIce" v-model="editProducto.prodIcePorcentajeId"  class="form-select border" id="prodIcePorcentajeId">
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="mb-3 col-md-6">                             
                            ...
                            <select v-model="editProducto.prodCtaCompras"  class="form-select border" id="prodCtaCompras">
                        ...
                        <div class="mb-3 col-md-6">                             
                            ...
                            <select v-model="editProducto.prodCtaVentas"  class="form-select border" id="prodCtaVentas">
                                <option v-for="lcc of listaCtaContable" v-bind:value="lcc.ctad_codigo">{{lcc.cuentadet}}</option>
                            </select>
                ...
                <div class="col-md-12 row">
                    ...
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodCompra" class="form-check-input" type="checkbox" id="prodCompra">
                            <label class="form-check-label" for="prodCompra">Puede Comprarse</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodVenta" class="form-check-input" type="checkbox" id="prodVenta">
                            <label class="form-check-label" for="prodVenta">Puede Venderse</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodIsServicio" class="form-check-input" type="checkbox" id="prodIsServicio">
                            <label class="form-check-label" for="prodIsServicio">Es Servicio</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodIsGasto" class="form-check-input" type="checkbox" id="prodIsGasto">
                            <label class="form-check-label" for="prodIsGasto">Es Gasto</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodIsPromo" class="form-check-input" type="checkbox" id="prodIsPromo">
                            <label class="form-check-label" for="prodIsPromo">Es Promoción</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodEspecificaciones" class="form-check-input" type="checkbox" id="prodEspecificaciones">
                            <label class="form-check-label" for="prodEspecificaciones">Tiene Especificaciones</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodIsSuperProducto" class="form-check-input" type="checkbox" id="prodIsSuperProducto">
                            <label class="form-check-label" for="prodIsSuperProducto">Es Superproducto</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodCtrlLote" class="form-check-input" type="checkbox" id="prodCtrlLote">
                            <label class="form-check-label" for="prodCtrlLote">Tiene Control de lote</label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodFacturarEnNegativo" class="form-check-input" type="checkbox" id="prodFacturarEnNegativo">
                            <label class="form-check-label" for="prodFacturarEnNegativo">Facturar en Negativo</label>
                        </div>
                    </div>
                    <div class="col-md-2">
                        <div class="form-check form-switch">
                            <input  v-model="editProducto.prodEstado" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault">
                ...
                <div class="modal-footer">
                    <button  class="btn btn-primary" @click="updateProducto()">
                        ...
                        <span>
                            <span v-if='updating'><i class="fas fa-spinner fa-spin"></i> Actualizando...</span>
